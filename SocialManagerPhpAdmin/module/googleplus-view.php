...
<form method="get" action="../module/googleplus-controller.php" class="embedgpsharebutton">
    ...
    <table style="border-width: 0">
        ...
        <tr <?php if ($GLOBALS['MODULE']['RSS']['IMAGE_FILE']==null) {echo 'style="display: none;"';}?>><td><input type="submit" name ="action" value="Image +Share(1-click)" <?php if(true) {echo 'disabled="disabled"';} ?>
        ...
        <tr><td><input type="submit" name ="action" value="Manual +Share" <?php if($GLOBALS['MODULE']['INQUEUE']) {echo 'disabled="disabled"';} ?> class="gpshare-popup"/></td></tr>
    </table>
</form>
